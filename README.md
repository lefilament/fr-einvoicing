...
* [OCA/bank-payment-alternative](https://github.com/OCA/account-payment) (only available on v18, dependencies of l10n_fr_einvoicing_payment_batch_oca)
...
* [OCA/l10n-france](https://github.com/OCA/l10n-france)
  ...
  * In addition to the above, for automatic configuration of UNECE tax codes, you may want to install l10n_fr_account_tax_unece or l10n_fr_account_oca
...
[l10n_fr_ereporting](l10n_fr_ereporting/) | 18.0.1.0.1 | <a href='https://github.com/alexis-via'><img src='https://github.com/alexis-via.png' width='32' height='32' style='border-radius:50%;' alt='alexis-via'/></a> | Community implementation of e-reporting for France
